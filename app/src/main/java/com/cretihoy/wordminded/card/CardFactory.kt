...
object CardFactory {
    ...
    fun getLetter(): List<CardModel> {
        return listOf(
            CardModel(content = string.letter_01),
            CardModel(content = string.letter_02),
            CardModel(content = string.letter_03),
            CardModel(content = string.letter_04),
            CardModel(content = string.letter_05),
            CardModel(content = string.letter_06),
            CardModel(content = string.letter_07),
            CardModel(content = string.letter_08),
            CardModel(content = string.letter_09),
    ...
    fun getTask(): List<CardModel> {
        return listOf(
            CardModel(content = string.task_01),
            CardModel(content = string.task_02),
            CardModel(content = string.task_03),
            CardModel(content = string.task_04),
            CardModel(content = string.task_05),
            CardModel(content = string.task_06),
            CardModel(content = string.task_07),
            CardModel(content = string.task_08),
            CardModel(content = string.task_09),
